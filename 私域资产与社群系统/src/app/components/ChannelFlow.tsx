...
const assignRules = [
  ...
  { id: 2, name: "小红书引流体验营", trigger: "来源：小红书 + 标签含「体验营」",
    wechat: "wx_sz_01", group: "深圳体验官群01", wecom: "不同步企微", priority: 2, active: true },
  ...
  { id: 4, name: "视频号直播间购买", trigger: "来源：视频号直播 + 任意购买",
    wechat: "wx_bj_01", group: "北京PRO会员群01", wecom: "同步企业微信", priority: 4, active: true },
  ...
  { id: 6, name: "知乎专栏引流", trigger: "来源：知乎 + 填写意向表单",
    wechat: "wx_bj_01", group: "北京游客群01", wecom: "不同步企微", priority: 6, active: false },
];

const trafficLog = [
  { time: "07-05 14:23", user: "李云天", phone: "138****4567", source: "抖音", sourceDetail: "视频《私域运营秘诀》评论区",
    assignedWeChat: "wx_bj_01", assignedGroup: "北京PRO会员群01", wecomSync: true, ruleHit: "抖音购买PRO会员" },
  { time: "07-05 13:45", user: "张晓红", phone: "139****4568", source: "小红书", sourceDetail: "eco_life 笔记《健康分享》",
    assignedWeChat: "wx_sh_01", assignedGroup: "上海游客群01", wecomSync: false, ruleHit: "小红书引流体验营" },
  { time: "07-05 11:20", user: "王建国", phone: "158****4569", source: "微信小店", sourceDetail: "代理授权套餐下单",
    assignedWeChat: "wx_gz_01", assignedGroup: "广州代理群01", wecomSync: true, ruleHit: "微信小店代理授权" },
  { time: "07-05 10:00", user: "陈美玲", phone: "137****4570", source: "公众号", sourceDetail: "官方公众号 · 关注引流",
    assignedWeChat: "wx_cd_01", assignedGroup: "成都分站群01", wecomSync: false, ruleHit: "公众号新关注用户" },
  { time: "07-04 18:30", user: "赵志远", phone: "186****4571", source: "视频号", sourceDetail: "直播回放《7月城市合伙人》",
    assignedWeChat: "wx_sz_01", assignedGroup: "深圳代理群01", wecomSync: true, ruleHit: "视频号直播间购买" },
  { time: "07-04 16:00", user: "孙伟明", phone: "152****4572", source: "小红书", sourceDetail: "eco_pro 笔记《PRO干货》",
    assignedWeChat: "wx_hz_01", assignedGroup: "杭州会员群01", wecomSync: false, ruleHit: "小红书引流体验营" },
  { time: "07-04 14:12", user: "刘晓峰", phone: "138****5432", source: "抖音", sourceDetail: "视频《社群运营》点击橱窗",
    assignedWeChat: "wx_bj_01", assignedGroup: "北京体验官群01", wecomSync: true, ruleHit: "抖音购买PRO会员" },
  { time: "07-04 09:30", user: "赵雨晴", phone: "139****4321", source: "公众号", sourceDetail: "官方公众号 · 文章引流",
    assignedWeChat: "wx_sh_01", assignedGroup: "上海游客群01", wecomSync: false, ruleHit: "公众号新关注用户" },
];
