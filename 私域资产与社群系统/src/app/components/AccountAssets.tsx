...
const mediaAccounts = [
  { id: 1, group: "微信生态", platform: "公众号", emoji: "📢", color: "#000000", colorBg: "#f0f0f0", name: "蜂乐玛官方", verified: true, loginType: "邮箱登录", loginId: "admin@fenglema.com", pwdStore: "公司密码库 1Password", followers: "12,800", contentCount: "286篇文章", lastPost: "2026-07-04", engagement: "4.2%", manager: "内容运营团队", status: "使用中", risk: "normal", note: "主要内容发布渠道，绑定小程序和视频号同一主体", tags: ["认证账号", "已绑小程序", "已绑视频号"] },
  { id: 2, group: "微信生态", platform: "视频号", emoji: "🎬", color: "#000000", colorBg: "#f0f0f0", name: "蜂乐玛视频", verified: true, loginType: "微信账号关联（无独立账号密码）", loginId: "关联公众号主体登录", pwdStore: "无需单独密码", followers: "4,200", contentCount: "68个视频", lastPost: "2026-07-03", engagement: "6.8%", manager: "内容运营团队", status: "使用中", risk: "normal", note: "与公众号同一主体，通过公众号后台管理，无需单独账号", tags: ["挂载公众号", "直播功能已开通"] },
  { id: 3, group: "内容平台", platform: "抖音", emoji: "🎵", color: "#000000", colorBg: "#f0f0f0", name: "@fenglema_official", verified: true, loginType: "手机号登录", loginId: "139-0012-3459", pwdStore: "公司密码库 1Password", followers: "28,600", contentCount: "142个视频", lastPost: "2026-07-05", engagement: "8.3%", manager: "张晓红", status: "使用中", risk: "normal", note: "主推流量渠道，已开通企业号橱窗，每周3-5条更新", tags: ["企业蓝V", "橱窗已开通", "直播已开通"] },
  { id: 4, group: "内容平台", platform: "小红书", emoji: "📕", color: "#000000", colorBg: "#f0f0f0", name: "fenglema_life", verified: false, loginType: "手机号登录（无需微信绑定）", loginId: "140-0012-3460", pwdStore: "公司密码库 1Password", followers: "9,300", contentCount: "234篇笔记", lastPost: "2026-07-04", engagement: "5.1%", manager: "王美丽", status: "使用中", risk: "normal", note: "生活方式内容为主，引流私域主账号", tags: ["个人号", "已申请专业号"] },
  { id: 5, group: "内容平台", platform: "小红书", emoji: "📕", color: "#000000", colorBg: "#f0f0f0", name: "fenglema_pro", verified: true, loginType: "邮箱登录（独立账号，不绑手机）", loginId: "pro@fenglema.com", pwdStore: "公司密码库 1Password", followers: "3,100", contentCount: "87篇笔记", lastPost: "2026-06-28", engagement: "7.4%", manager: "王美丽", status: "使用中", risk: "normal", note: "PRO会员专属内容账号，主打深度干货，导流加入PRO", tags: ["专业号", "PRO专属"] },
  { id: 6, group: "内容平台", platform: "微博", emoji: "🐦", color: "#000000", colorBg: "#f0f0f0", name: "@蜂乐玛", verified: true, loginType: "手机号登录", loginId: "158-0012-3465", pwdStore: "公司密码库 1Password", followers: "5,700", contentCount: "1,240条微博", lastPost: "2026-07-02", engagement: "1.8%", manager: "内容运营团队", status: "使用中", risk: "normal", note: "品牌官微，更新频率低，主要用于品牌背书和官方声明", tags: ["蓝V认证", "低频更新"] },
  { id: 7, group: "内容平台", platform: "B站", emoji: "📺", color: "#000000", colorBg: "#f0f0f0", name: "蜂乐玛官方", verified: false, loginType: "邮箱登录", loginId: "bili@fenglema.com", pwdStore: "公司密码库 1Password", followers: "2,100", contentCount: "23个投稿", lastPost: "2026-03-10", engagement: "3.2%", manager: "内容运营团队", status: "空闲", risk: "normal", note: "长视频内容账号，目前暂停更新，待规划内容方向后重启", tags: ["暂停更新", "待重启"] },
  { id: 8, group: "内容平台", platform: "快手", emoji: "⚡", color: "#000000", colorBg: "#f0f0f0", name: "蜂乐玛快手号", verified: false, loginType: "手机号登录", loginId: "186-0012-3470", pwdStore: "公司密码库 1Password", followers: "1,340", contentCount: "31个视频", lastPost: "2026-05-20", engagement: "2.9%", manager: "张晓红", status: "空闲", risk: "normal", note: "下沉市场测试账号，ROI不佳，暂停投入", tags: ["测试阶段", "暂停更新"] },
  { id: 9, group: "内容平台", platform: "知乎", emoji: "🔵", color: "#000000", colorBg: "#f0f0f0", name: "蜂乐玛创始人", verified: true, loginType: "手机号登录", loginId: "138-0012-3456", pwdStore: "创始人本人保管", followers: "4,680", contentCount: "56篇专栏", lastPost: "2026-06-30", engagement: "9.1%", manager: "创始人王总", status: "使用中", risk: "normal", note: "创始人个人IP，主写私域运营方法论，高质量引流", tags: ["创始人IP", "专栏已开通", "知乎认证"] },
  { id: 10, group: "内容平台", platform: "领英", emoji: "💼", color: "#000000", colorBg: "#f0f0f0", name: "蜂乐玛 FengleMa", verified: false, loginType: "邮箱登录（境外平台）", loginId: "admin@fenglema.com", pwdStore: "公司密码库 1Password", followers: "890", contentCount: "34篇动态", lastPost: "2026-06-15", engagement: "5.6%", manager: "内容运营团队", status: "空闲", risk: "normal", note: "面向B端和招募合伙人，更新频率低", tags: ["B端获客", "低频更新"] },
];
